...
export interface Schedule{
	...
	vacation: {
		...
		vacation.start_time: string;
		
		/** End time for vacation specified in RFC3339 format. */
		vacation.end_time: string;
	}
}
